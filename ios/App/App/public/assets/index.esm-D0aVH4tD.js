import{bY as y,bZ as b,b_ as T,b$ as S,c0 as K,c1 as be,c2 as W,c3 as D,c4 as Te,c5 as Y,c6 as J,c7 as X,c8 as Z,c9 as Ae,ca as ve,cb as q}from"./index-B5_XIaiz.js";const Q="@firebase/installations",F="0.6.20";/**
 * @license
 ...
 */const ee=1e4,te=`w:${F}`,ne="FIS_v2",Se="https://firebaseinstallations.googleapis.com/v1",ke=3600*1e3,Ee="installations",Re="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const me="installations",rt="installations-internal",st=e=>{const t=e.getProvider("app").getImmediate(),n=it(t),a=S(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:a,_delete:()=>Promise.resolve()}},ot=e=>{const t=e.getProvider("app").getImmediate(),n=S(t,me).getImmediate();return{getId:()=>tt(n),getToken:i=>nt(n,i)}};function ct(){b(new T(me,st,"PUBLIC")),b(new T(rt,ot,"PRIVATE"))}ct();y(Q,F);y(Q,F,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nt{constructor(t){this.app=t}_delete(){return delete I[this.app.options.appId],Promise.resolve()}}let I={},B=[];const U={};let P="dataLayer",xt="gtag",V,x,z=!1;function qt(){const e=[];if(Y()&&e.push("This is a browser extension environment."),J()||e.push("Cookies are not available."),e.length>0){const t=e.map((a,i)=>`(${i+1}) ${a}`).join(" "),n=d.create("invalid-analytics-context",{errorInfo:t});u.warn(n.message)}}function Lt(e,t,n){qt();const a=e.options.appId;if(!a)throw d.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)u.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw d.create("no-api-key");if(I[a]!=null)throw d.create("already-exists",{id:a});if(!z){wt(P);const{wrappedGtag:r,gtagCore:s}=Tt(I,B,U,P,xt);x=r,V=s,z=!0}return I[a]=$t(e,B,U,t,V,P,n),new Nt(e)}function Gt(e=Te()){e=D(e);const t=S(e,v);return t.isInitialized()?t.getImmediate():jt(e)}function jt(e,t={}){const n=S(e,v);if(n.isInitialized()){const i=n.getImmediate();if(Ae(t,n.getOptions()))return i;throw d.create("already-initialized")}return n.initialize({options:t})}async function Ht(){if(Y()||!J()||!X())return!1;try{return await Z()}catch{return!1}}function Bt(e,t,n){e=D(e),Ot(x,I[e.app.options.appId],t,n).catch(a=>u.error(a))}function Ut(e,t,n,a){e=D(e),Ft(x,I[e.app.options.appId],t,n,a).catch(i=>u.error(i))}const G="@firebase/analytics",H="0.10.20";function Vt(){b(new T(v,(t,{options:n})=>{const a=t.getProvider("app").getImmediate(),i=t.getProvider("installations-internal").getImmediate();return Lt(a,i,n)},"PUBLIC")),b(new T("analytics-internal",e,"PRIVATE")),y(G,H),y(G,H,"esm2020");function e(t){try{const n=t.getProvider(v).getImmediate();return{logEvent:(a,i,r)=>Ut(n,a,i,r),setUserProperties:(a,i)=>Bt(n,a,i)}}catch(n){throw d.create("interop-component-reg-failed",{reason:n})}}}Vt();export{Gt as getAnalytics,jt as initializeAnalytics,Ht as isSupported,Ut as logEvent,Bt as setUserProperties};
