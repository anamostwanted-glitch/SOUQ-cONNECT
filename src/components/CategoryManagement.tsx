...
import { Plus, Search, BarChart3, Layers, Tag, Combine, LayoutGrid, ListTree, Sparkles } from 'lucide-react';
        ...
        <div className="flex items-center gap-3 flex-wrap w-full sm:w-auto">
          ...
          <div className="flex items-center gap-1 bg-brand-background p-1 rounded-xl border border-brand-border">
            <button
              ...
              className={`p-2 rounded-lg transition-all ${viewMode === 'grid' ? 'bg-brand-surface text-brand-primary shadow-sm' : 'text-brand-text-muted hover:text-brand-text-main'}`}
              title="Grid View"
            >
              <LayoutGrid size={18} />
            </button>
            <button
              ...
              className={`p-2 rounded-lg transition-all ${viewMode === 'list' ? 'bg-brand-surface text-brand-primary shadow-sm' : 'text-brand-text-muted hover:text-brand-text-main'}`}
              title="List View"
            >
              <ListTree size={18} />
            </button>
