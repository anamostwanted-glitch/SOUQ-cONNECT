                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <a 
                            ...
                            className="text-brand-primary hover:text-brand-primary-hover p-1 bg-brand-primary/10 rounded-lg transition-colors"
                      ...
                      <div className="flex-1 relative">
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <button
                            ...
                            className="p-1 text-brand-primary hover:bg-brand-primary/10 rounded-lg transition-all disabled:opacity-50"
