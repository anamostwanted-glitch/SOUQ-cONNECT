...
async function run() {
  try {
    ...
    const numDays = Object.keys(trend).length;
    const avgDailyTotalCost = totalCost / (numDays || 1);
    const expectedDailyCostPerUser = avgDailyTotalCost / uniqueUsers;
